...
public class FutureQueue {
	...
	/** The sorted set. */
	private final SortedSet<SimEvent> sortedSet =Collections.synchronizedSortedSet( new ConcurrentSkipListSet<SimEvent>());
	 ...
	 * @return the iterator
	 */
	 synchronized public Iterator<SimEvent> iterator() {
